        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    ...
                    <h3 class="mb-3 mt-3">Теги материалов</h3>
                    <h4 class="mb-3 mt-3">Теги материалов работают по принципу хештегов в соцсетях. У одной публикации может быть несколько
                        тегов, которые бы отражали темы, затрагиваемые в посте.
                    </h4>
